  ...
  return (
    <>
      ...
      <main style={{ minHeight: '100vh', backgroundColor: 'var(--color-black)' }}>
        ...
        {/* FOOTER — extra bottom padding clears the fixed mobile sticky CTA bar above */}
        <footer style={{ backgroundColor: 'var(--color-black-soft)', borderTop: '1px solid rgba(255,255,255,0.06)', padding: '40px 20px 116px' }}>
